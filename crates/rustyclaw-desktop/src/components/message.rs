...
pub fn MessageBubble(props: MessageBubbleProps) -> Element {
    let (icon_class, bg_color, label) = match props.role {
        MessageRole::User => ("fa-user", "#3273dc", "You"),
        MessageRole::Assistant => ("fa-robot", "#209cee", "Assistant"),
        MessageRole::System => ("fa-cog", "#ffdd57", "System"),
    };
        ...
        div {
            ...
            BulmaBox {
                ...
                div {
                    ...
                    Icon { class: "is-small".to_string(), i { class: "fas {icon_class}" } }
                    span { style: "margin-left: 0.25rem;", "{label}" }
                }
