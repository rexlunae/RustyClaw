...
pub async fn exec_summarize_file_async(
    ...
    match ext.as_str() {
        "rs" | "py" | "js" | "ts" | "go" | "java" | "c" | "cpp" | "rb" | "sh" | "txt" | "md"
        | "toml" | "yaml" | "yml" | "json" | "xml" | "html" | "css" | "sql" | "csv" | "log" => {
