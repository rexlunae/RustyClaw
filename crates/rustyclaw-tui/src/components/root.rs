...
use crate::components::downloads_dialog::DownloadsDialog;
...
pub struct RootProps {
    ...
    // downloads dialog overlay (/downloads)
    pub show_downloads_dialog: bool,
    pub downloads_data: Option<rustyclaw_view::DownloadsData>,
...
pub fn Root(props: &mut RootProps) -> impl Into<AnyElement<'static>> {
    ...
    let show_downloads = props.show_downloads_dialog;
    let downloads = props.downloads_data.clone();
    let downloads_cursor = props.downloads_cursor;
