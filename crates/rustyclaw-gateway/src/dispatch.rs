...
pub(crate) async fn dispatch_text_message(
    ...
    for _round in 0..MAX_TOOL_ROUNDS {
        ...
        // result corresponds to the Nth tool_call. Using a HashMap lookup
        // would fail when multiple tool_calls share the same original ID
        // (the last insert overwrites earlier entries, causing all matching
